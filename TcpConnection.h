 ...
 *
 */
class TcpConnection : noncopyable, public std::enable_shared_from_this<TcpConnection> // 当前对象的智能指针
{
public:
    ///与已连接的sockfd构建TcpConnection
    ///用户不应该创建这个对象。
...
private:
    ...
    EventLoop *loop_; // 不是baseLoop， 因为TcpConnection都是在subLoop里面管理的
